...
namespace bms1
{
    public partial class Job_Challan : Form
    {
        public Job_Challan(string callas)
        {
            InitializeComponent();
        ...
        void fillservicercombo()
        {
            ...
            con.Open();
            string qurry = "Select * from [Servicer_T] ";
        ...
        void fillservicecombo()
        {
            ...
            con.Open();
            string qurry = "Select * from [JobWork_T] where supplier_ID_fkey='" + suppliercmbx.SelectedValue + "'";
            SqlCommand cmd = new SqlCommand(qurry, con);
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            ...
            try
            {
                ...
                servicecmb.DisplayMember = "Item_no";
                servicecmb.DataSource = dataDB;
                con.Close();
            }
            catch (Exception ex)
            {
        ...
        void add_new_item(int n)
        {
            SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["JobWorkDB"].ConnectionString);
            con.Open();
            string qurry = "select Item_no from JobWork_T where supplier_ID_fkey='" + suppliercmbx.SelectedValue + "'";
            ...
            qurry = "insert into JobWork_T (Item_no,description, hsn, date_, supplier_ID_fkey, author_ID_fkey) values('" + itno + "','" + itemdtdgv.Rows[n].Cells[1].Value + "','" + itemdtdgv.Rows[n].Cells[2].Value + "','" + DateTime.Now.ToString("yyyyMMdd") + "','" + suppliercmbx.SelectedValue + "','" + emplbl.Text + "') ";
            SqlCommand cmd1 = new SqlCommand(qurry, con);

            try
            {
                cmd1.ExecuteNonQuery();
                Ledger_Process.New_Ledger("Service_" + itno);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
        ...
        private void NavRec(int i = 0)
        {
            ...
            string qurry = "select * from ["+Calculator.get_temp_data(Constant_And_Variable.Company_id)+"Job_Challan_D_T] where Invo_ID_fkey ='" + billidtxt.Text + "'";
            SqlCommand cmd = new SqlCommand(qurry, con);
        ...
        void fill_ds()
        {
            SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["TranxDB"].ConnectionString);
            con.Open();
            string qurry = "select * from ["+Calculator.get_temp_data(Constant_And_Variable.Company_id)+"Job_Challan_T]";
            SqlCommand cmd = new SqlCommand(qurry, con);
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            try
            {
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (servicecmb.Text == "Select Work")
                {
            ...
            if (adchk)
            {
                ...
                try
                {
                    ...
                    {
                        itemno = ret_service_name(itemcmbx.SelectedValue.ToString());
                    }
                    amt = Convert.ToDouble(qntytxt.Text) * Convert.ToDouble(ratetxt.Text);
                    itemdtdgv.ReadOnly = false;
                    itemdtdgv.Rows.Add(itemno, itemcmbx.Text, descrptxt.Text, hsntxt.Text, qntytxt.Text, ratetxt.Text, amt.ToString());
                    itemdtdgv.ReadOnly = true;
        ...
        private void itemcmbx_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            qurry = "Select * from rate_T where stock_ID_fkey='" + ret_service_name
                (servicecmb.SelectedValue.ToString()) + "'";
        ...
        private void savebtn_Click_1(object sender, EventArgs e)
        {

            {
                if (check_condition())
                {
                    ...
                    string qurry = "insert into Job_Challan_T (Com_ID_fkey, send_id_fkey, date_, discrate, author_ID_fkey,stock_value) values('" + Calculator.get_temp_data(Constant_And_Variable.Company_id) + "','" + suppliercmbx.SelectedValue.ToString() + "','" + DateTime.Now.ToString("yyyyMMdd") + "','" + discrattxt.Text + "','" + emplbl.Text + "','" + stockvaluetxt.Text + "') ";
                    ...
                    try
                    {
                        ...
                        Ledger_Process.Ledger_Update("Company_" + Calculator.get_temp_data(Constant_And_Variable.Company_id), "Servicer_" + suppliercmbx.SelectedValue.ToString(), "Debit", billidtxt.Text, Convert.ToDouble(grtottxt.Text), "Sarees " + qntytxt.Text + " given for Work");
                    }
                    catch (Exception ex)
                    {
                        MessageBox.Show(ex.ToString());
                    ...
                    while (n < itemdtdgv.Rows.Count)
                    {
                        ...
                        qurry = "insert into Job_Challan_D_T (Invo_ID_fkey,job_ID_fkey, item_no_fkey, rate, qnty) values('" + billidtxt.Text + "','" + itemdtdgv.Rows[n].Cells[0].Value + "','" + itemdtdgv.Rows[n].Cells[2].Value + "','" + itemdtdgv.Rows[n].Cells[5].Value + "','" + itemdtdgv.Rows[n].Cells[4].Value + "') ";
                        ...
                        try
                        {
                            ...
                            Ledger_Process.Item_Update(comlbl.Text, "Item_" + itemdtdgv.Rows[n].Cells[1].Value.ToString(), "Credit", billidtxt.Text, Convert.ToDouble(itemdtdgv.Rows[n].Cells[4].Value.ToString()));
                        }
                        catch (Exception ex)
                        {
                            MessageBox.Show(ex.ToString());
                        ...
                        qurry = "insert into rate_T (job_ID_fkey,stock_ID_fkey,date_, bill_ID_fkey, rate) values('" + itemdtdgv.Rows[n].Cells[0].Value.ToString() + "','" + itemdtdgv.Rows[n].Cells[1].Value.ToString() + "','" + DateTime.Now.ToString("yyyyMMdd") + "','" + billidtxt.Text + "','" + itemdtdgv.Rows[n].Cells[5].Value + "')";
